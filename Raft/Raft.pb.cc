...
extern PROTOBUF_INTERNAL_EXPORT_Raft_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AppendEntriesRequest_LogEntry_Raft_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AppendEntriesRequest_Raft_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_AppendEntriesRequest_Raft_2eproto}, {
      &scc_info_AppendEntriesRequest_LogEntry_Raft_2eproto.base,}};

static void InitDefaultsscc_info_AppendEntriesRequest_LogEntry_Raft_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AppendEntriesRequest_LogEntry_Raft_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AppendEntriesRequest_LogEntry_Raft_2eproto}, {}};
...
static void InitDefaultsscc_info_RequestVoteRequest_Raft_2eproto() {
  ...
  {
    void* ptr = &::rpcService::_RequestVoteRequest_default_instance_;
    new (ptr) ::rpcService::RequestVoteRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::rpcService::RequestVoteRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_RequestVoteResponse_Raft_2eproto() {
  ...
  {
    void* ptr = &::rpcService::_RequestVoteResponse_default_instance_;
    new (ptr) ::rpcService::RequestVoteResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::rpcService::RequestVoteResponse::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Raft_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteRequest, term_),
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteRequest, lastlogindex_),
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteRequest, lastlogterm_),
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteRequest, candidatename_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteResponse, term_),
  PROTOBUF_FIELD_OFFSET(::rpcService::RequestVoteResponse, votegranted_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::rpcService::AppendEntriesRequest_LogEntry)},
  { 8, -1, sizeof(::rpcService::AppendEntriesRequest)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpcService::_RequestVoteRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::rpcService::_RequestVoteResponse_default_instance_),
};
...
const char descriptor_table_protodef_Raft_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\024\n\014LastLogIndex\030\002 \001(\004\022\023\n\013LastLogTerm\030\003 \001"
  "(\004\022\025\n\rCandidateName\030\004 \001(\t\"8\n\023RequestVote"
  "Response\022\014\n\004Term\030\001 \001(\004\022\023\n\013VoteGranted\030\002 "
  "\001(\0102\254\001\n\013RaftService\022T\n\rAppendEntries\022 .r"
  "pcService.AppendEntriesRequest\032!.rpcServ"
  "ice.AppendEntriesResponse\022G\n\004Vote\022\036.rpcS"
  "ervice.RequestVoteRequest\032\037.rpcService.R"
  "equestVoteResponseB\003\200\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Raft_2eproto = {
  false, false, descriptor_table_protodef_Raft_2eproto, "Raft.proto", 711,
...
void AppendEntriesRequest_LogEntry::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AppendEntriesRequest_LogEntry_Raft_2eproto.base);
  commandname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
RequestVoteRequest::RequestVoteRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:rpcService.RequestVoteRequest)
}
RequestVoteRequest::RequestVoteRequest(const RequestVoteRequest& from)
  ...
  if (!from._internal_candidatename().empty()) {
    candidatename_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_candidatename(),
      GetArena());
  }
  ::memcpy(&term_, &from.term_,
    static_cast<size_t>(reinterpret_cast<char*>(&lastlogterm_) -
    reinterpret_cast<char*>(&term_)) + sizeof(lastlogterm_));
  // @@protoc_insertion_point(copy_constructor:rpcService.RequestVoteRequest)
}
...
RequestVoteRequest::~RequestVoteRequest() {
  // @@protoc_insertion_point(destructor:rpcService.RequestVoteRequest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:rpcService.RequestVoteRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "rpcService.RequestVoteRequest.CandidateName"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestVoteRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:rpcService.RequestVoteRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->candidatename().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "rpcService.RequestVoteRequest.CandidateName");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_candidatename(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpcService.RequestVoteRequest)
  return target;
}

size_t RequestVoteRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpcService.RequestVoteRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpcService.RequestVoteRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestVoteRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestVoteRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpcService.RequestVoteRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpcService.RequestVoteRequest)
    MergeFrom(*source);
  }
}

void RequestVoteRequest::MergeFrom(const RequestVoteRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpcService.RequestVoteRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpcService.RequestVoteRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpcService.RequestVoteRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
RequestVoteResponse::RequestVoteResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:rpcService.RequestVoteResponse)
}
RequestVoteResponse::RequestVoteResponse(const RequestVoteResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:rpcService.RequestVoteResponse)
}
...
RequestVoteResponse::~RequestVoteResponse() {
  // @@protoc_insertion_point(destructor:rpcService.RequestVoteResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:rpcService.RequestVoteResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestVoteResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:rpcService.RequestVoteResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:rpcService.RequestVoteResponse)
  return target;
}

size_t RequestVoteResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:rpcService.RequestVoteResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:rpcService.RequestVoteResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestVoteResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestVoteResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:rpcService.RequestVoteResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:rpcService.RequestVoteResponse)
    MergeFrom(*source);
  }
}

void RequestVoteResponse::MergeFrom(const RequestVoteResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:rpcService.RequestVoteResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:rpcService.RequestVoteResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpcService.RequestVoteResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RaftService::Vote(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::rpcService::RequestVoteRequest*,
                         ::rpcService::RequestVoteResponse*,
                         ::google::protobuf::Closure* done) {
...
void RaftService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    ...
    case 1:
      Vote(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::rpcService::RequestVoteRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::rpcService::RequestVoteResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& RaftService::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::rpcService::RequestVoteRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& RaftService::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::rpcService::RequestVoteResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void RaftService_Stub::Vote(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
template<> PROTOBUF_NOINLINE ::rpcService::RequestVoteRequest* Arena::CreateMaybeMessage< ::rpcService::RequestVoteRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpcService::RequestVoteRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::rpcService::RequestVoteResponse* Arena::CreateMaybeMessage< ::rpcService::RequestVoteResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::rpcService::RequestVoteResponse >(arena);
}
